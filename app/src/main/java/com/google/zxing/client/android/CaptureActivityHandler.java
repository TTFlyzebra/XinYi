...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            case Contents.ID.restart_preview:
                restartPreviewAndDecode();
                break;
            case Contents.ID.decode_succeeded:
                state = State.SUCCESS;
                ...
                break;
            case Contents.ID.decode_failed:
    ...
    public void quitSynchronously() {
        ...
        Message quit = Message.obtain(decodeThread.getHandler(), Contents.ID.quit);
        quit.sendToTarget();
        try {
        ...
        removeMessages(Contents.ID.decode_succeeded);
        removeMessages(Contents.ID.decode_failed);
    }
