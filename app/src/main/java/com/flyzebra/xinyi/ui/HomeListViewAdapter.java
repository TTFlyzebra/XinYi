...
/*
*list的Key值约定
* mealimage-图像的路径，如http://127.0.0.1/image/1.png
* name-名称
* price-价格
 */
public class HomeListViewAdapter extends BaseAdapter {
	private final String TV01 = "mealname";
	private final String TV02 = "mealprice";
	private final String IV01 = "mealimage";
	...
	public HomeListViewAdapter(Context context, List<Map<String, Object>> list,int idListview) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageUtils.ShowImageView("http://192.168.1.88/ordermeal"+list.get(position).get(IV01),holder.iv01);
		return convertView;
	}
