...
public class FlyLog {
    ...
    public static String[] filter = {"<ChildViewPager>", "<ChildGridView>", "<DrawerLayoutUtils>", "<PoiFragment>", "<HomeFragment>", "<RefreshRecyclerView>", "<MainActivity>","<MyVolley>","<StarLevel>"};
